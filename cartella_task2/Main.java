...
public class Main {
        ...
        ListaProdotti.add(new Prodotto_Alimentare("Pane", 1.20));
        ListaProdotti.add(new Prodotto_Alimentare("Nutella", 4.20));
        ListaProdotti.add(new Prodotto_Elettronico("Televisore", 1220));
        ListaProdotti.add(new Prodotto_Elettronico("Mouse", 20));
        ListaProdotti.add(new Prodotto_Libro("A Clockwork Orange", 20.90));
        ListaProdotti.add(new Prodotto_Libro("L'ultimo a morire", 22.50));
